...
description: 依据已有三普成果报告和地方资料，编纂、续写、审查或规范排版县级土壤志。先建立资料与证据台账，再形成章节契约、土种记述和可追溯志稿；土特产等专题按适用性处理。用于县级土壤志全流程，不替代原始土壤调查、检测或重新评价。
---
...
[assets/project](assets/project) 可复制为工作目录：项目状态、资料台账、证据、指标、冲突、可比性、图件、必需内容映射、土种覆盖、具体缺口、格式配置及写作检查模板。先据实际资料填写，不能仅填六章“完成”就视为内容齐备。示例字段是待填写的业务槽位，不是目标县事实；正式稿不得残留模板提示。
